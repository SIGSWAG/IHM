package com.insa.thibault.ihm.view.custom;
...
public class RectImageView extends ImageView {
    ...
    public Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int radius) {
        ...
        int y = (int) ( bitmap.getHeight() * Math.tan(angleRad));

        Point point1_draw = new Point(0, 0);
        Point point2_draw = new Point(bitmap.getWidth(), bitmap.getHeight());
        Point point3_draw = new Point(bitmap.getWidth(),  0);
        Point point4_draw = new Point(y,  bitmap.getHeight());
    ...
    private double getRadFromDeg(int deg){
